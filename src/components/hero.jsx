...
const Hero = () => {
  const [activeData, setActiveData] = React.useState(DrinkData[0]);
        ...
        <div className="container grid grid-cols-1 md:grid-cols-2 min-h-[605px]">
          ...
          <div className="flex flex-col justify-center py-14 md:py-0 xl:max-w-[500px] order-2 md:order-1">
            <div className="space-y-5 text-center md:text-left">
              ...
              {/* ______ Drink List Separator ______ */}
          ...
          <div className="text-3xl right-10 text-white fixed bottom-10 hover:rotate-[360deg] duration-500 z-[99999] mix-blend-difference">
            <a href="">
              <FaWhatsapp />
            </a>
          </div>
